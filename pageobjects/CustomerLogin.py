...
class CustLogin:
    ...
    cust_log_head = "//span[@class='base' and @data-ui-id='page-title-wrapper' and text()='Customer Login']"
    ...
    def capt_cl_head(self):
        # Capture the header title text and handle any exceptions
        try:
            return wait_for_element(self.driver, self.cust_log_head).text

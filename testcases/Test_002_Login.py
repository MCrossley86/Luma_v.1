# add the following imports - HomePage, CustomerLogin, CustomLog ReadProperties and os
# in ReadProperties create static methods for email and password. Add to config.ini
# create a class
# in Test_002 add the variables baseURL=getapplicationurl(), logger, email=getuseremail() and password=getuserpassword()
# create method
    # launch browser, click sign in, enter details, click create, check for "Home Page" title
# create a group
